...
hdl_interrupt_t mod_irq_exti1 = {
  .irq_cnf = hdl_module_config(hdl_interrupt_config_t,
    .irq_type = HDL_NVIC_IRQ7_EXTI1,
    .priority = 0,
    .priority_group = 0
  )
};
...
hdl_exti_controller_t mod_exti_controller = {
  ...
  .config = hdl_module_config(hdl_exti_controller_config_t,
    .extis = hdl_extis(&exti0_cnf, &exti1_cnf),
    .phy = EXTI
  )
};
...
const hdl_gpio_pin_t mod_gpio_pa0 = {
  ...
  .mod_var = static_malloc(HDL_MODULE_VAR_SIZE),
  .dependencies = hdl_module_dependencies(&hdl_gpio_port_a, &mod_exti_controller),
...
const hdl_adc_source_t mod_adc_source_3 = {
  .channel = HDL_ADC_CHANNEL_3,
  .sample_time = HDL_ADC_CHANNEL_SAMPLE_TIME_7P5
};

const hdl_adc_source_t mod_adc_source_7 = {
  .channel = HDL_ADC_CHANNEL_3,
  .sample_time = HDL_ADC_CHANNEL_SAMPLE_TIME_7P5
};
...
const hdl_adc_config_t mod_adc0_cnf = {
  ...
  .init_timeout = 3000,
  .sources = hdl_adc_src(&mod_adc_source_3, &mod_adc_source_7),
};
...
const hdl_eeprom_i2c_t mod_eeprom_m24M01 = {
  .iface = &hdl_eeprom_iface,
  .dependencies = hdl_module_dependencies(&mod_i2c0, &mod_systick_timer),
  .config = hdl_module_config(hdl_eeprom_i2c_config_t,
    .chip_address = 0x50,
    .page_size = 256,
    .write_time = 4,
    .size = 1024*128
...
extern const hdl_gpio_pin_t mod_sns_pwr_pin                        __attribute__ ((alias ("mod_gpio_pb5")));
extern const hdl_gpio_pin_t mod_acc_pwr_pin                        __attribute__ ((alias ("mod_gpio_pa2")));
extern const hdl_gpio_pin_t mod_acc_int1_pin                       __attribute__ ((alias ("mod_gpio_pa0")));
extern const hdl_gpio_pin_t mod_acc_int2_pin                       __attribute__ ((alias ("mod_gpio_pa1")));
extern const hdl_adc_t mod_adc                                     __attribute__ ((alias ("mod_adc0")));
extern hdl_interrupt_t acc_int1                                    __attribute__ ((alias ("mod_irq_exti0")));
extern hdl_interrupt_t acc_int2                                    __attribute__ ((alias ("mod_irq_exti1")));
const uint32_t adc_src_id_cur                                      = 0;
const uint32_t adc_src_id_volt                                     = 1;
...
extern const hdl_nvm_t mod_storage                                 __attribute__ ((alias ("mod_eeprom_m24M01")));
